...
//    t3lib_utility_Debug::debug($title ,'ac_chart');
    if($tsArr['10.']['10.']['text']) {
      if($title) {
...
//t3lib_utility_Debug::debug($tsArr['10.']['10.']['text'], 'ac_chart');
...
//    t3lib_utility_Debug::debug($tsArr['10.']['20.']['10.'][$seriesCnt . '.']['lineColor'] ,'ac_chart');
